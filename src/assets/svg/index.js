export const Timer = () => (
    ...
    >
        ...
        />
        <path fill="#000" d="M64 73.6l-3-.4.8-34 2.2-3.7 2.2 3.7.8 34z">
            <animateTransform
...
export const Loading = ({ width, height }) => (
    <svg
        ...
        xmlSpace="preserve"
    >
        <circle fill="#11cdef" stroke="none" cx="6" cy="50" r="6">
            <animateTransform
                attributeName="transform"
                dur="1s"
                type="translate"
        ...
        <circle fill="#11cdef" stroke="none" cx="30" cy="50" r="6">
            <animateTransform
                attributeName="transform"
                dur="1s"
                type="translate"
        ...
        <circle fill="#11cdef" stroke="none" cx="54" cy="50" r="6">
            <animateTransform
                attributeName="transform"
                dur="1s"
                type="translate"
